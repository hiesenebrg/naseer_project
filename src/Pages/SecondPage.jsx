...
const FirstPage = () => {
  ...
  return (
    <>
      ...
      <div className="text-sm text-center mt-3 font-light">
      ...
      <div className="border-solid bg-slate-300 hover:bg-blue-700 hover:text-white p-2 px-8 w-[12vw] m-auto mt-4 rounded-xl">
        Continue
      </div>
    </>
  );
